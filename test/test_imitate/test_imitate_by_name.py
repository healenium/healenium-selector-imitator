...
def test_imitate_by_name():
    user_selector = Selector(selector_type=SelectorType.BY_NAME, other_attributes={"name": "element1"})
    target_node = Node(tag="h1", other_attributes={"name": "element_1"})
    expected_result = Selector(selector_type=SelectorType.BY_NAME, other_attributes={"name": "element_1"})
